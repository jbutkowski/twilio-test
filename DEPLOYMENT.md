...
sudo service unicorn_twilio <start|stop|restart>
sudo service sidekiq_twilio <start|stop>
```
...
```
/home/deployer/apps/twilio/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_twilio restart
sudo service sidekiq_twilio stop
sudo service sidekiq_twilio start
```
